package org.semanticweb.ore.wrappers;
 ...
 * </p>
 */
public class OREv1ReasonerWrapper {
	private OWLOntology ont;
	private ThreadMXBean bean;
	private String errorLog;
	private String reasonerFactoryClass;
	
	/**
	 * Constructor for a simple reasoner wrapper
	 * @param ont	OWL Ontology
	 */
	public OREv1ReasonerWrapper(OWLOntology ont, String reasonerFactoryClass) {
		this.ont = ont;
		this.reasonerFactoryClass = reasonerFactoryClass;
...
//		return new JFactFactory().createReasoner(ont);
		...
		try {
			factoryClass = Class.forName(reasonerFactoryClass);
		    factory = (OWLReasonerFactory) factoryClass.newInstance();
		    return factory.createReasoner(ont);
		} catch (Exception e) {
...
//			man.saveOntology(man.createOntology((Set<OWLAxiom>) results, iri), new OWLFunctionalSyntaxOntologyFormat(), iri);
	...
	public static void main(String[] args) throws OWLOntologyCreationException {
		...
		OREv1ReasonerWrapper r = new OREv1ReasonerWrapper(ont,"uk.ac.manchester.cs.jfact.JFactFactory");
